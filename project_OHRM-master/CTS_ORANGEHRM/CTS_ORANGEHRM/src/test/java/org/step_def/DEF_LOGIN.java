...
public class DEF_LOGIN extends lib_utility {
	...
	public void i_enter_the_and(String username, String pswd) throws Throwable {
	    ...
	    selutil.takeSnapShot("H:\\eclipsejava\\CTS_ORANGEHRM\\src\\test\\resources\\screenshots\\LoginPage.png");
	}
	...
	public void i_am_on_Home_page() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
		selutil=new sel_util(dr);
	    selutil.takeSnapShot("H:\\eclipsejava\\CTS_ORANGEHRM\\src\\test\\resources\\screenshots\\Logged_in.png");
	    login=new OHRM_LOGIN(dr);
	    login.close_driver();
	}
}
